...
const DOWNLOAD_MAP: Record<OS, { file: string; label: string }> = {
  macOS: { file: "Auto-Issue-0.2.2-arm64.dmg", label: "Download for macOS" },
  Windows: { file: "Auto-Issue-Setup-0.2.2.exe", label: "Download for Windows" },
  Linux: { file: "Auto-Issue-0.2.2.AppImage", label: "Download for Linux" },
};
